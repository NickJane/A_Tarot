...
namespace Lib.Utils
{
    ...
    public class RequestHelper
    {
        ...
        public static string GetIp()
        {
            ...
            var remoteAddr = HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"];
            var httpVia = HttpContext.Current.Request.ServerVariables["HTTP_VIA"];
            return String.IsNullOrEmpty(httpVia) ? remoteAddr : httpVia;
        }
        ...
        {
            int result;
            if (!int.TryParse(HttpContext.Current.Request[str], out result)) result = defaultValue;
            return result;
        }
