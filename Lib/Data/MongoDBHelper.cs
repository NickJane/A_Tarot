...
namespace Lib.Data
{
    ...
    //where T :class
    {
        ...
        public static readonly string connectionString_Default = Lib.Utils.ConfigHelper.GetAppSetting("MongdbServer"); // System.Configuration.ConfigurationManager.AppSettings["ConnectionString_mongoDB"];
        ...
        public static List<T> GetAll<T>(string collectionName, IMongoQuery query=null)
        {
