...
using HashSet = Lib.Utils.BadWords.HashStringSet;
...
namespace Lib.Utils
{
    ...
    /// 再优化(替换HashSet)
    /// 使用方法 
    /// 实例化 BadWordsFilter4 bf4 = new BadWordsFilter4();
    /// 循环添加各种垃圾字到集合中 bf4.AddKey(key); 比如 源代码
    /// return bf4.Replace(text);即可
    /// </summary>
