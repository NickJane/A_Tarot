        ...
        */
        function drawLinks() {
            ...
            var appendItem = function (page_id, appendopts) {
                ...
                if (tempappendopts) { lnk.removeAttr('class'); lnk.addClass(appendopts.classes); }
                panel.append(lnk);
            }
            ...
            //            panel.append("<span  style='vertical-align:middle'><input id='txtPaginationIndex' value='" + (opts.current_page + 1) + "' style='width:30px;vertical-align:middle' /></span>");
            //            panel.append("<span  style='vertical-align:middle'><a id='btnGo' href='javascript:void(0);'>go</a></span>");
