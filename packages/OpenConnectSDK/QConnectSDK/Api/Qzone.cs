...
namespace QConnectSDK.Api
{
    ...
    public partial class RestApi
    {
        ...
        public OAuthToken GetAccessToken(string oAuthVericode, string state)
        {
            ...
            Lib.Utils.LogHelper.CustomLog("开始通过Authorization Code获取Access Token,," + dt.ToString("yyyy-MM-dd HH:mm:ss") + "\r\n");
            var response = Execute(request);
            Lib.Utils.LogHelper.CustomLog("结束通过Authorization Code获取Access Token,," + (DateTime.Now- dt).TotalMilliseconds+ "\r\n");
        ...
        private string GetOpenId(string accessToken)
        {
            ...
            DateTime dt = DateTime.Now;
            Lib.Utils.LogHelper.CustomLog("开始获取GetOpenId,," + dt.ToString("yyyy-MM-dd HH:mm:ss") + "\r\n");
            var response = Execute(request);
            Lib.Utils.LogHelper.CustomLog("结束获取GetOpenId,," + (DateTime.Now - dt).TotalMilliseconds + "\r\n");
